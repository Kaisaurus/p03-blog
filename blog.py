...
class Post(ndb.Model):
    ...
    def render(self, current_user):
        ...
        return render_str_jinja("post.html", p=self, current_user=current_user,comments=self.comments)
...
class Comment(ndb.Model):
    ...
    def render(self, current_user):
        ...
        self.username = User.by_id(self.user_id).name
        return render_str_jinja("comment.html", c=self, username=self.username , current_user=current_user)
